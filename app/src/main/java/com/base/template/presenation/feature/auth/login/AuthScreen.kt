...
import com.base.template.presenation.theme.FontColor
...
fun AuthScreen(navController: NavController) {
    ...
    Column(
        ...
        Column(Modifier.background(color = Color.White, RoundedCornerShape(topStart = 25.dp, topEnd = 25.dp)).fillMaxWidth().fillMaxSize()
            .weight(1f)
            .padding(25.dp)
